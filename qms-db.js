...
const SB={
  ...
  /* [v2.59 D1-2] select().single()으로 삽입된 id 반환 */
  ...
  /* [v2.59 D1] deleteDocMaster SB 메서드 */
  /* [v2.59] 소프트 삭제 — RLS 우회 + 복구 가능 */
...
SB.addEquipment = async function(row) {
  ...
  try {
    ...
    /* [v2.59] 타입 정제 — 빈 문자열·undefined → null, numeric 컬럼 변환
